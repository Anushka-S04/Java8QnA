...
public class StreamExample4 {
	...
	public static void main(String[] args) {
		...
		.forEach(b->System.out.println(b.id+" "+b.name+" "+b.author+" "+b.publisher+" "+b.quantity));
		...
		System.out.println("Max qty of books: "+bk1.quantity+"->"+bk1.name);
		
		Book bk2=list.stream().min((book1,book2)->book1.quantity>book2.quantity?1:-1).get();
		System.out.println("Min qty of books: "+bk2.quantity+"->"+bk2.name);
		...
		System.out.println("Total books with qty <7 :"+count1);

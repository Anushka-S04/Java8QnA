...
class ColorBagJUnit5Test {
	...
	/*
	 The @BeforeEach annotation denotes that the annotated method should be executed before each @Test, @RepeatedTest, @ParameterizedTest, and @TestFactory methods in the current class. 
	...
	void testToList() {
		...
		var colorList=colorBag.toList(); //convert set into list
